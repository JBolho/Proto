...
int isp_a7_qos_cfg(void)
{
    ...
    __raw_writel(QOS_PRIO_3_PLUS_RD, (volatile void __iomem*)(SOC_VIVO_BUS_ISP_RD_QOS_PRIORITY_ADDR(vivobus_base)));
    ...
    __raw_writel(QOS_PRIO_3,         (volatile void __iomem*)(SOC_VIVO_BUS_A7T0VIVOBUS_RD_QOS_PRIORITY_ADDR(vivobus_base)));
    __raw_writel(QOS_FIX_MODE,       (volatile void __iomem*)(SOC_VIVO_BUS_A7T0VIVOBUS_RD_QOS_MODE_ADDR(vivobus_base)));
    __raw_writel(QOS_PRIO_1,         (volatile void __iomem*)(SOC_VIVO_BUS_A7T0VIVOBUS_WR_QOS_PRIORITY_ADDR(vivobus_base)));
