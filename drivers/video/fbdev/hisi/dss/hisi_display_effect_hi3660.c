...
int hisi_effect_arsr2p_info_set(struct hisi_fb_data_type *hisifd, struct arsr2p_info *arsr2p)
{
	...
	memcpy(hisifd->effect_info.arsr2p, arsr2p, sizeof(struct arsr2p_info)*3);
...
int hisi_effect_arsr2p_config(struct arsr2p_info *arsr2p_effect_dst, int ih_inc, int iv_inc)
{
	...
	if ((spin_can_lock(&hisifd_primary->effect_lock)) && (hisifd_primary->effect_updated_flag.arsr2p_effect_updated)) {
		...
		if (hisifd_primary->effect_info.arsr2p[0].update == 1) {
			memcpy(&(arsr2p->arsr2p_effect), &(hisifd_primary->effect_info.arsr2p[0]), sizeof(struct arsr2p_info));
		}

		if (hisifd_primary->effect_info.arsr2p[1].update == 1) {
			memcpy(&(arsr2p->arsr2p_effect_scale_up), &(hisifd_primary->effect_info.arsr2p[1]), sizeof(struct arsr2p_info));
		}

		if (hisifd_primary->effect_info.arsr2p[2].update == 1) {
			memcpy(&(arsr2p->arsr2p_effect_scale_down), &(hisifd_primary->effect_info.arsr2p[2]), sizeof(struct arsr2p_info));
		}
